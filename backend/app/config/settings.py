...
class Settings:
    ...
    ALLOWED_ORIGINS: list = os.getenv(
        "ALLOWED_ORIGINS",
        "http://localhost:3000,http://localhost:3001,https://healthcare-ai-assistant-beta.vercel.app"
    ).split(",")
    ...
    # MCP Server
    # CRITICAL: This must point to the deployed MCP server in production
    MCP_SERVER_URL: str = os.getenv("MCP_SERVER_URL", "https://healthcare-ai-assistant-r0mw.onrender.com")
