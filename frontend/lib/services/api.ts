...
// Backend API URL - Used for patient data, appointments, medical records
const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || 'https://healthcare-ai-assistant-1.onrender.com';

// MCP Server URL - Used for AI agent orchestration and chat
const MCP_URL = process.env.NEXT_PUBLIC_MCP_URL || 'https://healthcare-ai-assistant-r0mw.onrender.com';
